...
# =================================================
# Sync Shopify Orders From 15 September
# =================================================
...
async def sync_missing_orders():
    ...
    try:
        ...
        params = {
            "status": "any",
            "limit": 250,
            "created_at_min": "2026-09-15T00:00:00Z",
            "order": "id asc"
        }
        ...
        while True:
            ...
            # Continue with Shopify's next URL
            url = next_url
        ...
        return {
            ...
            "shopify_orders_found": total_found,
